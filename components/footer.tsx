...
const footerLinks = {
    courses: [
        { label: "Namaz Fundamentals", href: "#" },
        { label: "Quran Recitation", href: "#" },
        { label: "Islamic History", href: "#" },
        { label: "Arabic Language", href: "#" },
    ],
    company: [
        { label: "About Us", href: "#about" },
        { label: "Our Scholars", href: "#" },
                        ...
                        <div className="flex gap-4 mt-6">
                            {socialLinks.map((social) => (
                                <a
                                    key={social.label}
                                    href={social.href}
                                    className="flex items-center justify-center w-10 h-10 rounded-full bg-muted hover:bg-primary hover:text-white text-muted-foreground transition-colors duration-200"
